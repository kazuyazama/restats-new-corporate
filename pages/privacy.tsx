        ...
        <div className=" max-w-screen-xl mx-auto">
          <div>
            <h1 className="text-lg pb-10">
              株式会社リ・スターツ（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
            </h1>
            <ul className="grid gap-8">
              <li className="flex flex-col gap-2">
                <h3 className=" font-semibold">第1条（個人情報）</h3>
                <p>
                  「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報及び容貌、指紋、声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
                </p>
              </li>
              <li className="flex flex-col gap-2">
                <h3 className=" font-semibold">第2条（個人情報の収集方法）</h3>
                <p>
              ...
              <li className="flex flex-col gap-2">
                <h3 className=" font-semibold">第4条（利用目的の変更）</h3>
                <ol className="list-decimal list-inside">
                  <li>
                ...
                <ol className="list-decimal list-inside">
                  ...
                  <li>
                    ...
                    <ol className="list-decimal list-inside pl-4">
                      ...
                      <li>
                        個人情報を特定の者との間で共同して利用する場合であって、その旨並びに共同して利用される個人情報の項目、共同して利用する者　の範囲、利用する者の利用目的および当該個人情報の管理について責任を有する者の氏名または名称について、あらかじめ本人に通知　し、または本人が容易に知り得る状態に置いた場合
                      </li>
                    </ol>
                  </li>
                </ol>
              ...
              <li className="flex flex-col gap-2">
                <h3 className=" font-semibold">第6条（個人情報の開示）</h3>
                <ol className="list-decimal list-inside">
                  <li>
              ...
              <li className="flex flex-col gap-2">
                <h3 className=" font-semibold">第10条（お問い合わせ窓口）</h3>
                <h4>
                  本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。
                </h4>
                <ul>
                  <li>住所：東京都町田市森野6-359 横山第2ビル 2-A</li>
                  <li>社名：株式会社リ・スターツ</li>
                  <li>Eメールアドレス：info@restarts.co.jp</li>
                </ul>
              </li>
            </ul>
          </div>
