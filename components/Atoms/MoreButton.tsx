...
const MoreButton = ({ children, borderWidth, color,hoverColor, path }: Props) => {
    ...
    <>
      <Link href={path}>
        <a className="flex items-center group ">
          <span
            className={`relative text-xl tracking-wider font-semibold text-${color}  ${underLine} before:opacity-0 before:group-hover:animate-scale-in-left`}
          >
            {children}
          </span>
